 ...
 * VW_Melrose_WhatsApp_Bot_Flow.pdf (verbatim script).
 *
 * Button / list titles live in src/fsm/states.js (optionTitles).
 * Placeholders: {{APPLICATION_LINK}} {{STOCK_LINK}}
 */
module.exports = {
  // Melrose script has no per-turn footer.
  ...
  greeting_prompt: [
    ...
    "If you get stuck, I'm watching closely. I'll step in.",
  ...
  // Promotions content TBD per Melrose open items — keep branch reachable.
  promotions_body:
    'Promotions — content coming soon. Tap below to return to the main menu.',
  ...
  send_link_body: [
    'Here is the link: {{APPLICATION_LINK}}',
